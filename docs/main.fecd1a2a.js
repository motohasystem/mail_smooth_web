...
var PrepareMailbody = /*#__PURE__*/function () {
  ...
  _createClass(PrepareMailbody, [{
    ...
    value: function build_forms(node_id) {
      ...
      // FROMフィールド
      var label_from = utils_1.Utils.ce('label', 'col-4 mb-2', [], "入力テキスト");
      ...
      // TOフィールド
      var label_to = utils_1.Utils.ce('label', 'col-4 mb-2', [], "読み上げ用テキスト");
      ...
      })]), textfield_from, utils_1.Utils.ce("div", "row mt-3", [utils_1.Utils.ce('div', 'col-5', [], "分割文字数の目安: "), field_limit]), utils_1.Utils.ce('div', 'row', [btn_run]), utils_1.Utils.ce("div", 'row', [label_to, utils_1.Utils.ce('span', 'col-4', [], '', {
