...
var PrepareMailbody = /*#__PURE__*/function () {
  ...
  _createClass(PrepareMailbody, [{
    ...
    function build_forms(node_id) {
      ...
      })]), textfield_from, utils_1.Utils.ce("div", "row mt-3", [utils_1.Utils.ce('div', 'col-5', [], "split about: "), field_limit]), utils_1.Utils.ce('div', 'row', [btn_paste, btn_run, btn_clear]), utils_1.Utils.ce("div", 'row', [label_to, utils_1.Utils.ce('span', 'col-4', [], '', {
    ...
    value: function create_textarea(id) {
      ...
      // clearボタンの有無を切り分ける
      if (clear_buttons) {
        var btn_clear_top = PrepareMailbody.create_remove_to_top("erase before", id);
        var btn_clear_bottom = PrepareMailbody.create_remove_to_bottom("erase after", id);
        buttons = [btn_clear_top, btn_input_top, btn_input_bottom, btn_clear_bottom];
      } else {
