...
var PrepareMailbody = /*#__PURE__*/function () {
  ...
  _createClass(PrepareMailbody, [{
    ...
    function build_forms(node_id) {
      ...
      // 実行ボタン
      var btn_run = utils_1.Utils.ce('input', 'btn btn-primary col-10 mt-3 mb-4', [], '', {
        type: 'button',
        value: 'smoothing',
      ...
      // クリアボタン
      var btn_clear = utils_1.Utils.ce('input', "btn btn-outline-danger col-2 mt-3 mb-4", [], '', {
        type: 'button',
        value: 'clear',
      ...
      var textfield_from = PrepareMailbody.create_textarea(constants_1.CONST.ID_TEXT_FROM, default_from);
      ...
      })]), textfield_from, utils_1.Utils.ce("div", "row mt-3", [utils_1.Utils.ce('div', 'col-5', [], "split about: "), field_limit]), utils_1.Utils.ce('div', 'row', [btn_run, btn_clear]), utils_1.Utils.ce("div", 'row', [label_to, utils_1.Utils.ce('span', 'col-4', [], '', {
